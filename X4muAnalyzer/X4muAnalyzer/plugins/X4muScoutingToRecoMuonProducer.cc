 ...
 * 2024-10
 * X4muScoutingToRecoMuonProducer unpacks Run3ScoutingMuon formats to reco format
...
class X4muScoutingToRecoMuonProducer : public edm::stream::EDProducer<> {
public:
  explicit X4muScoutingToRecoMuonProducer(edm::ParameterSet const &iConfig);
  ~X4muScoutingToRecoMuonProducer() override;
...
reco::Muon X4muScoutingToRecoMuonProducer::createMuon(Run3ScoutingMuon const& scoutingMuon) {
  auto m = 0.1056583755;
...
void X4muScoutingToRecoMuonProducer::produce(edm::Event &iEvent, edm::EventSetup const &setup) {
  using namespace edm;
  ...
  auto pfcands = std::make_unique<reco::MuonCollection>();
...
reco::Track X4muScoutingToRecoMuonProducer::createTrack(Run3ScoutingTrack const& scoutingTrack){
...
reco::Track X4muScoutingToRecoMuonProducer::createTrack(Run3ScoutingMuon const& scoutingMuon){
...
void X4muScoutingToRecoMuonProducer::createMuons(
...
void X4muScoutingToRecoMuonProducer::createTracks(
    edm::Handle<std::vector<Run3ScoutingMuon>> scoutingmuonHandle,
    std::unique_ptr<reco::TrackCollection> &scoutingtracks) {
  for (unsigned int icand = 0; icand < scoutingmuonHandle->size(); ++icand) {
    auto &scoutingmuon = (*scoutingmuonHandle)[icand];
...
DEFINE_FWK_MODULE(X4muScoutingToRecoMuonProducer);